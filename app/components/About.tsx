      ...
      <div className="grid lg:grid-cols-2 gap-16 items-start">
        ...
        <div>
          ...
          <p className="reveal text-slate-400 leading-relaxed mb-5 text-base">
            ...
            <span className="text-[#00d4ff] font-semibold">98% accuracy</span>.
          </p>
          ...
          <div className="reveal flex flex-wrap gap-4">
            <a
              ...
              className="flex items-center gap-2.5 px-5 py-2.5 rounded-full glass-card border border-[rgba(0,212,255,0.2)] text-[#00d4ff] text-sm font-medium hover:border-[#00d4ff] hover:bg-[rgba(0,212,255,0.08)] transition-all"
            >
            ...
            <a
              ...
              className="flex items-center gap-2.5 px-5 py-2.5 rounded-full glass-card border border-[rgba(124,58,237,0.25)] text-[#a78bfa] text-sm font-medium hover:border-[#7c3aed] hover:bg-[rgba(124,58,237,0.08)] transition-all"
            >
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            {highlights.map((h, i) => (
              <div
                key={i}
                className="reveal glass-card p-5 hover:border-[rgba(0,212,255,0.3)] hover:-translate-y-1 transition-all duration-300"
